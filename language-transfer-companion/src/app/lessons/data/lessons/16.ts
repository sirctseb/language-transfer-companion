...
const data: Data = {
  vocabulary: [
    [
      { language: "english", word: "the house" },
      { language: "greek", word: "το σπίτι", latinized: "to spíti" },
    ],
    [
      { language: "english", word: "home" },
      { language: "greek", word: "σπίτι", latinized: "spíti" },
    ],
    [
      { language: "english", word: "after" },
      { language: "greek", word: "μετά", latinized: "metá" },
    ],
    [
      { language: "english", word: "day" },
      { language: "greek", word: "μέρα", latinized: "méra" },
    ],
    [
      { language: "english", word: "good (masculine)" },
      { language: "greek", word: "καλός", latinized: "kalós" },
    ],
    [
    ...
    [
      { language: "english", word: "today" },
      { language: "greek", word: "σήμερα", latinized: "símera" },
    ],
    [
...
const exampleSentences = [
  [
    { language: "english", word: "We are waiting here." },
    {
      language: "greek",
      word: "Περιμένουμε εδώ.",
      latinized: "periménume edhó",
    },
  ],
  [
  ...
  [
    ...
    { language: "greek", word: "Είμαι στο σπίτι.", latinized: "íme sto spíti" },
  ],
  [
    { language: "english", word: "I am at home." },
    { language: "greek", word: "Είμαι σπίτι.", latinized: "íme spíti" },
  ],
  [
  ...
  [
    { language: "english", word: "The day." },
    { language: "greek", word: "Η μέρα.", latinized: "i méra" },
  ],
  [
    { language: "english", word: "Good day." },
    { language: "greek", word: "Καλημέρα.", latinized: "kaliméra" },
  ...
  [
    { language: "english", word: "Alexander is waiting for me there." },
    {
      language: "greek",
  ...
  [
    { language: "english", word: "Maria is at home now." },
    {
      language: "greek",
      word: "Η Μαρία είναι στο σπίτι τώρα.",
      latinized: "i maría íne sto spíti tóra",
    },
  ],
  [
    { language: "english", word: "Maria is not at home." },
    {
      language: "greek",
      word: "Η Μαρία δεν είναι στο σπίτι.",
      latinized: "i maría dhen íne sto spíti",
    },
  ],
  [
    { language: "english", word: "She’s waiting for you here." },
    {
      language: "greek",
      word: "Σε περιμένει εδώ.",
      latinized: "se periméni edhó",
    },
  ],
  [
